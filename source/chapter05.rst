...
引入了一个名为 **x** 的 *回指语* :sup:`（10.3）` 供这些形式使用。我们将在 :doc:`chapter06` 中进一步介绍。
...
举一个这个代码遍历是有用的的例子，让我们重新讨论在  :ref:`3-3-control-structures` 中忽略
...
程序对所提供的表达式进行代码遍历，方法与 :ref:`3-5-unwanted-capture` 中的 **defmacro/g!** 宏一样。

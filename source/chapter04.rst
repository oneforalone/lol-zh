...
包含 *循环* 的列表。 我们在 :ref:`4-5-cyclic-expressions` 中会详细地讨论循环。
...
COMMON LISP 的一个重要特性，将在 :doc:`chapter06` 进一步讨论。
...
一个有用的读取宏是 **#=** 。 在 :ref:`3-5-unwanted-capture` 中，我们已经看到了如何在序列化宏展开式时使用
